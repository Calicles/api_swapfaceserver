...
{	
	...
	string filename3("./test.png");
	string data("./shape_predictor_68_face_landmarks.dat");
	...
	points1 = dect.getLandMark(filename1);
	points2 = dect.getLandMark(filename2);
	cout << "p1: " << points1.size() << " p2: " << points2.size() << endl;
